...
import { getMaterials, getDestinations } from '../api/costApi'
...
export default function CostForm({ onSubmit, isLoading }: CostFormProps) {
  ...
  useEffect(() => {
    const loadOptions = async () => {
      try {
        const [mats] = await Promise.all([getMaterials()])
        setMaterials(mats)
      } catch (error) {
