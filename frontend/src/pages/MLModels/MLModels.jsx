...
export default function MLModels() {
  ...
  const mockModels = [
    ...
    { id: 3, name: 'Delay Classifier', version: '1.8', status: 'loaded', accuracy: 89.5, type: 'classification', key: 'delay_classifier' },
    { id: 4, name: 'Delay Regressor', version: '1.8', status: 'loaded', accuracy: 88.9, type: 'regression', key: 'delay_regressor' },
    { id: 5, name: 'Throughput Optimization', version: '2.0', status: 'loaded', accuracy: 91.3, type: 'regression', key: 'throughput' },
    { id: 6, name: 'Cost Estimation', version: '1.9', status: 'loaded', accuracy: 92.1, type: 'regression', key: 'cost' },
    { id: 7, name: 'Mode Selection', version: '1.5', status: 'loaded', accuracy: 87.8, type: 'classification', key: 'mode_classifier' },
  ]
  ...
  return (
    <div className="p-8 space-y-6 bg-gray-50 min-h-screen">
      ...
      {/* Tabs */}
      <div className="flex gap-4 border-b border-gray-200 bg-white px-6 py-4 rounded-t-lg">
