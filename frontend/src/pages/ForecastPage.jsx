    ...
    <div className="p-8 space-y-8">
      ...
      {activeTab === 'main' && (
        <>
          <MLModelsStatus
            models={[
              { name: 'XGBoost Regressor', version: '2.1', status: 'active', accuracy: 94.2, type: 'regression' },
              { name: 'LightGBM', version: '1.9', status: 'active', accuracy: 91.8, type: 'regression' },
              { name: 'Isolation Forest', version: '1.5', status: 'active', accuracy: 89.3, type: 'classification' },
              { name: 'Genetic Algorithm', version: '2.0', status: 'active', accuracy: 92.1, type: 'optimization' },
              { name: 'ARIMA', version: '1.8', status: 'active', accuracy: 87.5, type: 'regression' },
              { name: 'K-Means Clustering', version: '1.6', status: 'active', accuracy: 90.2, type: 'clustering' },
              { name: 'Random Forest', version: '2.2', status: 'active', accuracy: 93.7, type: 'regression' },
              { name: 'Gradient Boosting', version: '1.8', status: 'active', accuracy: 89.5, type: 'classification' },
              { name: 'Support Vector Regression', version: '1.8', status: 'active', accuracy: 88.9, type: 'regression' },
              { name: 'Neural Network (LSTM)', version: '2.0', status: 'active', accuracy: 91.3, type: 'regression' },
              { name: 'CatBoost', version: '1.9', status: 'active', accuracy: 92.1, type: 'regression' },
              { name: 'Logistic Regression', version: '1.5', status: 'active', accuracy: 87.8, type: 'classification' },
              { name: 'Decision Tree Classifier', version: '1.7', status: 'active', accuracy: 88.4, type: 'classification' },
              { name: 'Prophet (Facebook)', version: '1.9', status: 'active', accuracy: 90.6, type: 'regression' },
              { name: 'Naive Bayes', version: '1.4', status: 'active', accuracy: 86.2, type: 'classification' },
              { name: 'Particle Swarm Optimization', version: '2.1', status: 'active', accuracy: 93.5, type: 'optimization' },
              { name: 'Ensemble (Voting)', version: '1.6', status: 'active', accuracy: 89.8, type: 'regression' },
            ]}
          />
